...
pair<Matrix,bool> GaussSeidelMethod(Matrix A, Matrix b, Matrix &XO, int MaxIter=1000, double TOL=1e-8)
{
...
int main(int argc, char const *argv[])
{
  ...
  pair<Matrix,bool> Soluciones=GaussSeidelMethod(Sistema.first,Sistema.second,XO);
