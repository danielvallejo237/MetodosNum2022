/* Implementación de la favtorización LU con el método de Crout
@Author Daniel Vallejo (danielvallejo237) un Github
Para este caso si vamos a usar dos matrices L y U de forma que no ahorraremos memoria alguna
*/
...
Matrix SolveUsingCrout(Matrix &A, Matrix &b)
{
    //Solución de ecuaciones usando el método de Crout
    Matrix S2;
...
int main(int argv, char* argc[])
{
    ...
    Matrix Sol=SolveUsingCrout(A,b);
