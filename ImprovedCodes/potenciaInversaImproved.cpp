...
pair<vector<double>,double> GetFirstInversePower(vector<double> v0,Matrix A,Matrix L,Matrix U,int maxiter=10000,double TOL=1e-8)
{
  vector<double> v1;
...
pair<vector<double>,double> IthInversePower(vector<double> v0,Matrix A,Matrix L,Matrix U,vector<vector<double>> M,int ind,int maxiter=10000,double TOL=1e-8)
{
  vector<double> v1;
  double lambda=10000000;
  double old_lambda=100000000;
...
void ComputeEigs(Matrix A, int Numvals)
{
  ...
  pair<pair<Matrix,Matrix>,double> LU=LUDecomposition(A);
